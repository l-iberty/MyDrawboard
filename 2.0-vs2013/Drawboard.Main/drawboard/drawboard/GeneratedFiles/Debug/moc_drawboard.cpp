...
struct qt_meta_stringdata_drawboard_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_drawboard_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_drawboard_t qt_meta_stringdata_drawboard = {
    {
QT_MOC_LITERAL(0, 0, 9) // "drawboard"
...
const QMetaObject drawboard::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_drawboard.data,
      qt_meta_data_drawboard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *drawboard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_drawboard.stringdata0))
