...
QVector<QPoint> &Shape::getKeyPoints() { return m_KeyPoints; }
...
void Shape::updateKeyPoints(int index, QPoint &point) { m_KeyPoints.replace(index, point); }

void Shape::removeLastKeyPoints() { m_KeyPoints.removeLast(); }

void Shape::addKeyPoints(QMouseEvent *evt) { addKeyPoints(evt->pos()); }

void Shape::addKeyPoints(QPoint &point) { m_KeyPoints.push_back(point); }

void Shape::clearKeyPoints() { m_KeyPoints.clear(); }
...
QRect &Shape::getModel() { return m_Model; }
