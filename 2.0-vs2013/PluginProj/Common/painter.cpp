...
void Painter::setDraggingShape(Shape *shape) { m_pDraggingShape = shape; }
...
void Painter::setStartPoint(QPoint &point) { m_StartPoint = QPoint(point.rx(), point.ry()); }

void Painter::setEndPoint(QPoint &point) { m_EndPoint = QPoint(point.rx(), point.ry()); }

QPoint &Painter::getStartPoint() { return m_StartPoint; }

QPoint &Painter::getEndPoint() { return m_EndPoint; }

QList<Shape *> &Painter::getShapeList() { return m_ShapeList; }

Shape *Painter::getShapeListItem(int i) { return m_ShapeList.at(i); }

bool Painter::isEmptyShapeList() { return m_ShapeList.isEmpty(); }
